...
readOption:
    ...
    #System.out.println("4. Create Sparse Array A" );
    la $a0,Create_Spare_Array_A
    li $v0,4
    syscall

    #System.out.println("4. Create Sparse Array B" );
    la $a0,Create_Spare_Array_B
    li $v0,4
    syscall

    #System.out.println("5. Create Sparse Array C = A + B");
    la $a0,Create_Spare_Array_C
    li $v0,4
    syscall

    #System.out.println("8. Display Sparse Array A");
    la $a0,Display_Sparse_Array_A
    li $v0,4
    syscall

    #System.out.println("8. Display Sparse Array B");
    la $a0,Display_Sparse_Array_B
    li $v0,4
    syscall

    #System.out.println("8. Display Sparse Array C");
    la $a0,Display_Sparse_Array_C
    li $v0,4
    syscall
...
#-----------------readOption-----------------------------------------------
line:                             .asciiz "\n-----------------------------\n"
Read_Array_A:                     .asciiz "1.Read Array A \n"
Read_Array_B:                     .asciiz "2.Read Array B \n"
Create_Spare_Array_A:             .asciiz "3.Create Sparse Array A \n"
Create_Spare_Array_B:             .asciiz "4.Create Sparse Array B \n"
Create_Spare_Array_C:             .asciiz "5.Create Sparse Array C= A + B \n"
Display_Sparse_Array_A:           .asciiz "6.Display Sparse Array A \n"
Display_Sparse_Array_B:           .asciiz "7.Display Sparse Array B \n"
Display_Sparse_Array_C:           .asciiz "8.Display Sparse Array C \n"
Exit:                             .asciiz "0.Exit \n"
